...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    KC_ESC,            KC_Q,     KC_W,     KC_E,           KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,    KC_O,     KC_P,     TD(TD_LBRC_RBRC),  KC_BSPC,
    KC_TAB,            KC_A,     KC_S,     KC_D,           KC_F,     KC_G,     KC_H,     KC_J,     KC_K,    KC_L,     KC_SCLN,  KC_ENT,
    TD(TD_LSFT_CAPS),  KC_Z,     KC_X,     KC_C,           KC_V,     KC_B,     KC_B,     KC_N,     KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,           MO(3),
    KC_LCTL,           KC_LALT,  KC_LGUI,  MO(1),  KC_SPC,   KC_RGUI,  KC_RALT,  MO(2)
  ),
  [1] = LAYOUT(
    KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS, KC_EQL,
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_QUOT,  KC_BSLS,
