...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_LCTL      , MO(2) , KC_LGUI , KC_NO , KC_NO , KC_SPC , KC_NO , KC_RSFT , KC_RALT , TG(3)
  ),
  [1] = LAYOUT(
      ...
      KC_TRNS , KC_TRNS , KC_TRNS , KC_NO   , KC_NO   , KC_TRNS , KC_NO   , KC_TRNS , KC_TRNS , RESET
  ),
  [2] = LAYOUT(
      KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,
  ...
  [3] = LAYOUT(
      ...
      KC_LSFT , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_F9   , KC_F10  , KC_F11  , KC_F12 , KC_TRNS ,
