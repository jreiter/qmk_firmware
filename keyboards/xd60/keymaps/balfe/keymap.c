...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT_all(
      ...
      F(1), KC_NO,   KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH,  F(2),  F(2),  F(2),  \
      KC_TRNS, KC_LALT, KC_LGUI,                          F(0),                          KC_TRNS, KC_RGUI, MO(_FL), MO(_FL), MO(_FL)),

// Function Layer
  [_FL] = LAYOUT_all(
      KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,    KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_DEL,  \
      KC_TRNS, KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS, KC_CALC, KC_INS,  KC_PGUP,  KC_UP,   KC_PGDN, KC_PSCR, KC_SLCK, KC_PAUS, KC_TRNS, \
      KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS,  KC_TRNS, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END, KC_TRNS, KC_TRNS, KC_TRNS, \
...
const uint16_t PROGMEM fn_actions[] = {
    [0] = ACTION_LAYER_TAP_KEY(_FL, KC_SPACE),
    [1] = ACTION_LAYER_MODS(_LS, MOD_LSFT),
    [2] = ACTION_LAYER_MODS(_RS, MOD_RSFT),
};
